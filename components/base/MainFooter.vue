<template>
  <div class="bg-[#14071B]">
    <div
      class="max-w-[1200px] mx-auto xl:px-[10px] lg:px-[30px] lg:px-[60px] md:px-[36px] px-[16px]"
    >
      <div class="py-[60px] w-full flex md:flex-row flex-col items-start justify-between">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 items-start md:mt-[0] mt-[40px]">
          ...
          <div class="lg:mt-[0] md:mt-[40px] mt-[40px] flex items-center space-x-[26px]">
      ...
      <div class="py-[32px] border-t border-[#291732]">
        <p class="text-[#5B4B63] md:text-[16px] text-[14px] text-center">
          © AgencyAi 2023. All rights reserved.
        </p>
      </div>
    </div>
  </div>
